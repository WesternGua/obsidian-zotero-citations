...
export const I18N: { zh: I18NDict; en: I18NDict } = {
  zh: {
    ...
    "settings.defaultStyleDesc": "仅显示 Zotero 当前已经安装的 CSL 样式。插件不会提供内置或近似样式。",
    "settings.noStylesInstalled": "Zotero 中没有可用的 CSL 样式",
    "settings.selectInstalledStyle": "请选择 Zotero 已安装的样式",
    ...
    "export.bbtMissing": "无法连接 Better BibTeX。如需导出 Zotero 动态引文域，请确保 Zotero 正在运行且 Better BibTeX 已启用。",
    "export.styleMissing": "当前文档包含 Zotero 引用，但未选择 Zotero 已安装的 CSL 样式。请先在插件设置或文档首选项中选择样式。",
    "export.citationKeysMissing": "无法从 Better BibTeX 获取以下 Zotero 条目的 citation key：{keys}",
    "export.citationTransformFailed": "无法将插件引用转换为 Pandoc 引用：{error}",
    ...
    "footnote.zoteroOffline": "Zotero 未连接，已阻止修改定位，以避免用旧缓存重写引用。请先打开 Zotero。",
    ...
    "prefs.noStylesInstalled": "没有从 Zotero 读取到 CSL 样式。请先在 Zotero 中安装样式。",
    "prefs.selectInstalledStyle": "请先选择一个 Zotero 已安装的 CSL 样式。",
    ...
    "notice.selectInstalledStyle": "请先在插件设置中选择一个 Zotero 已安装的 CSL 样式。",
    "notice.styleRemoved": "Zotero 已不再安装样式“{style}”。插件已停止使用该样式，请重新选择。",
    "notice.styleFormatFailed": "无法使用 Zotero 当前的 CSL 样式排版。文档未被改写。详细信息：{error}",
    ...
    "notice.exportSuccess": "导出成功！在 Word 中点击 Zotero Refresh 即可刷新动态引文。\n{path}",
  ...
  en: {
    ...
    "settings.defaultStyleDesc": "Only CSL styles currently installed in Zotero are shown. The plugin provides no built-in or approximate styles.",
    "settings.noStylesInstalled": "No CSL styles are available in Zotero",
    "settings.selectInstalledStyle": "Select a style installed in Zotero",
    ...
    "export.bbtMissing": "Could not connect to Better BibTeX. To export live Zotero citation fields, make sure Zotero is running and Better BibTeX is enabled.",
    "export.styleMissing": "This document contains Zotero citations, but no CSL style installed in Zotero is selected. Select one in the plugin settings or Document Preferences first.",
    "export.citationKeysMissing": "Better BibTeX did not return citation keys for these Zotero items: {keys}",
    "export.citationTransformFailed": "Could not convert plugin-managed citations to Pandoc citations: {error}",
    ...
    "footnote.zoteroOffline": "Zotero is not connected, so the locator edit was blocked to avoid rewriting the citation with stale cached metadata. Open Zotero first.",
    ...
    "prefs.noStylesInstalled": "No CSL styles were read from Zotero. Install a style in Zotero first.",
    "prefs.selectInstalledStyle": "Select a CSL style that is installed in Zotero first.",
    ...
    "notice.selectInstalledStyle": "Select a CSL style installed in Zotero in the plugin settings first.",
    "notice.styleRemoved": "Zotero no longer has the style \"{style}\" installed. The plugin stopped using it; select another style.",
    "notice.styleFormatFailed": "The current Zotero CSL style could not format the citation. The document was not rewritten. Details: {error}",
    ...
    "notice.exportSuccess": "Export successful. Click Zotero Refresh in Word to update the live citations.\n{path}",
